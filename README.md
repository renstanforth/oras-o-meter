...
- [Window 1 - main timer + progress ring](mockups/v1.0.0/Window%201.png)  
- [Window 2 - task list + editable titles](mockups/v1.0.0/Window%202.png)  
- [Settings - Set main hour and break time length](mockups/v1.0.0/Settings.png)
- [Browser Notification — Pomodoro break prompt](mockups/v1.0.0/Pomodoro.png)  
